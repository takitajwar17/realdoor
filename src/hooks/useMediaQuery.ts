 ...
 * Alias for useMediaQuery("MD_AND_SMALLER") — prefer this in components that only
 * need a simple mobile/desktop split.
 */
export const useIsMobile = () => useMediaQuery("MD_AND_SMALLER")
