...
export const signUpAction = createServerAction()
  ...
  .handler(async ({ input }) => {
    return withRateLimit(async () => {
      ...
      if (existingUser) {
        throw new ZSAError("CONFLICT", "An account already uses this email. Sign in instead.");
      }
      ...
      if (!user || !user.email) {
        throw new ZSAError("INTERNAL_SERVER_ERROR", "We could not create your account. Try again.");
      }
